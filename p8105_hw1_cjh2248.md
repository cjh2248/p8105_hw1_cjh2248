...
```
    ...
    ##            <dbl> <chr>    <lgl>             <fct>     
    ##  1         0.454 red      TRUE              Level 1   
    ##  2        -0.376 orange   FALSE             Level 2   
    ##  3        -0.198 yellow   FALSE             Level 1   
    ##  4        -1.69  blue     FALSE             Level 3   
    ##  5        -0.499 green    FALSE             Level 3   
    ##  6        -1.56  pink     FALSE             Level 1   
    ##  7        -0.643 purple   FALSE             Level 2   
    ##  8        -1.12  black    FALSE             Level 1   
    ##  9        -1.09  white    FALSE             Level 2   
    ## 10         0.249 gray     TRUE              Level 3
...
the data not being quantifable.
